...
verifiable, and necessary. Use as a placeholder to indicate when necessary 
...
any external policies or regulations that state safety issues that affect the 
 design or use. Define any safety certifications that must be 
satisfied.$>$
...
$<$D'efine all the terms necessary to properly interpret the SRS, including 
